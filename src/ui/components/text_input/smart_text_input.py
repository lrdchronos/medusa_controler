...
from .clipboard_helper import copy_to_system_clipboard, paste_from_system_clipboard
...
class SmartTextInput(gui.UIInputText):
    ...
    def copy_to_clipboard(self) -> bool:
        ...
        if selected:
            return copy_to_system_clipboard(selected)
        return False
    ...
    # --- Renderização Visual Customizada ---
    ...
    def _render_cached_text(
        ...
        """Renderiza texto utilizando cache do arcade.Text."""
